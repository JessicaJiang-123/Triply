...
The project specification and sprint planning are documented in: [f25_team_1 Kanban Board](https://github.com/orgs/cmu-webapps/projects/44)
...
- [Unsplash API (for fetching relevant photos)](https://unsplash.com/documentation#search-photos)
- [Mapbox Documentation (for map and search features)](https://docs.mapbox.com/)
